...
// TaggedThreadsOrErr returns the TaggedThreads value or an error if the edge
// was not loaded in eager-loading.
func (e TagEdges) TaggedThreadsOrErr() ([]*Thread, error) {
	if e.loadedTypes[0] {
		return e.TaggedThreads, nil
	}
	return nil, &NotLoadedError{edge: "tagged_threads"}
}
...
func (t *Tag) QueryTaggedThreads() *ThreadQuery {
	return NewTagClient(t.config).QueryTaggedThreads(t)
}
