...
// The CommentKudoFunc type is an adapter to allow the use of ordinary
// function as CommentKudo mutator.
type CommentKudoFunc func(context.Context, *ent.CommentKudoMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CommentKudoFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CommentKudoMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CommentKudoMutation", m)
}
...
// The ThreadKudoFunc type is an adapter to allow the use of ordinary
// function as ThreadKudo mutator.
type ThreadKudoFunc func(context.Context, *ent.ThreadKudoMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ThreadKudoFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ThreadKudoMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ThreadKudoMutation", m)
}
