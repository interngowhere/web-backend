...
func (md *ModeratorDelete) Where(ps ...predicate.Moderator) *ModeratorDelete {
...
func (md *ModeratorDelete) sqlExec(ctx context.Context) (int, error) {
...
// Where appends a list predicates to the ModeratorDelete builder.
func (mdo *ModeratorDeleteOne) Where(ps ...predicate.Moderator) *ModeratorDeleteOne {
